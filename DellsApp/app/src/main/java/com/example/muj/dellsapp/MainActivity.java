...
try{
            ...
            try{
            Toast.makeText(getApplication(), "Loading graphs for age factor on Sales of Products", Toast.LENGTH_SHORT).show();}
            catch (Exception e){}
        }
            ...
            try{
                Toast.makeText(getApplication(), "Loading graphs for Service factor on Sales of Products", Toast.LENGTH_SHORT).show();}
            catch (Exception e){}
        }
            ...
            try{
                Toast.makeText(getApplication(), "Loading graphs for Gender factor on Sales of Products", Toast.LENGTH_SHORT).show();}
            catch (Exception e){}
        }
