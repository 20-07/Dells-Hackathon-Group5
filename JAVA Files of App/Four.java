 ...
 */
public class Four extends Fragment implements View.OnClickListener , AdapterView.OnItemClickListener, AdapterView.OnItemSelectedListener {
    View view;WebView ww3;  Button b1; TextView u00,u0,u1,u2,u3,u4,u5,u6,u7,u8,u9;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ww3=(WebView) view.findViewById(R.id.werit);

        ww3.setWebViewClient(new MyBrowser());
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                ww3.loadUrl("http://" + ((MainActivity)getActivity()).keyofip  +  "/top_t.py");
...
//                    catch(Exception e) {}
                    ...
                    new Handler().postDelayed(new Runnable() {
                        public void run() {
                            ...
                            ww3.loadUrl("http://" + ((MainActivity)getActivity()).keyofip  +  "/reg_dem.py?reg=" + reg);
